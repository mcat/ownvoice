...
import { useModelBoot } from "./hooks/useModelBoot";
...
import { isGPUReady, onGPUReady } from "./models/ttsEngine";
import { setFallbackVoice } from "./speak";
...
export function App() {
  ...
  // Boot the TTS + STT workers, arm download-resume and pre-gen backoff,
  // prime Web Speech voices, and auto-run the OPFS primer when needed.
  useModelBoot();
