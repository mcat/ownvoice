  ...
  return [
    {
      ...
      phrases: [
        ...
        phrase("needs.medical.call_light", "\uD83D\uDEA8", locale),
      ...
      subs: [
        {
          ...
          phrases: [
            ...
            phrase("needs.comfort.bathroom", "\uD83D\uDEBB", locale),
            phrase("needs.comfort.hearing_aid", "\uD83E\uDDBB", locale),
            phrase("needs.comfort.glasses", "\uD83D\uDC53", locale),
            phrase("needs.comfort.ice", "\uD83E\uDDCA", locale),
            phrase("needs.comfort.pillow", "\uD83E\uDEB6", locale),
            phrase("needs.comfort.turn", "\uD83D\uDD04", locale),
            phrase("needs.comfort.sit_up", "\uD83E\uDE91", locale),
            phrase("needs.comfort.quiet", "\uD83E\uDD2B", locale),
            phrase("needs.comfort.lights_on", "\uD83D\uDCA1", locale),
            phrase("needs.comfort.lights_off", "\uD83C\uDF19", locale),
            phrase("needs.comfort.lights_dimmed", "\uD83D\uDD05", locale),
          ],
        },
        {
          ...
          phrases: [
            ...
            phrase("needs.hygiene.wound", "\uD83E\uDE79", locale),
            phrase("needs.medical.call_light", "\uD83D\uDEA8", locale),
          ],
        },
        {
          ...
          phrases: [
            ...
            phrase("needs.people.respiratory_therapist", "\uD83E\uDEC1", locale),
            phrase("needs.people.speech_therapist", "\uD83D\uDCAC", locale),
          ],
        },
        {
          label: t("sub.hygiene", locale),
          phrases: [
            phrase("needs.hygiene.back", "\uD83E\uDDF4", locale),
            phrase("needs.hygiene.face", "\uD83E\uDDD6", locale),
            phrase("needs.hygiene.feet", "\uD83E\uDDB6", locale),
            phrase("needs.hygiene.hair", "\uD83D\uDC87", locale),
            phrase("needs.hygiene.hands", "\uD83E\uDDFC", locale),
            phrase("needs.hygiene.mouth", "\uD83D\uDC44", locale),
            phrase("needs.hygiene.nose", "\uD83D\uDC43", locale),
            phrase("needs.hygiene.teeth", "\uD83E\uDDB7", locale),
          ],
        },
      ],
    },
      ...
      subs: [
        {
          ...
          phrases: [
            ...
            phrase("feelings.physical.worse", "\uD83D\uDCC9", locale),
            phrase("feelings.physical.dizzy", "\uD83D\uDE35\u200D\uD83D\uDCAB", locale),
            phrase("feelings.physical.itchy", "\uD83E\uDD0F", locale),
            phrase("feelings.physical.wet", "\uD83D\uDCA6", locale),
            phrase("feelings.physical.gagging", "\uD83E\uDD2E", locale),
            phrase("feelings.physical.short_of_breath", "\uD83E\uDEC1", locale),
            phrase("needs.medical.breathe", "\uD83D\uDE2E\u200D\uD83D\uDCA8", locale),
            phrase("feelings.physical.nauseated", "\uD83E\uDD22", locale),
    ...
    },
    {
      ...
      phrases: [
        ...
        phrase("questions.extubation", "\u23F0", locale),
      ],
    },
