...
const zh: LocaleStrings = {
  ...
  "ui.provider.settings.accessibility.pointer_hint_body":
    "建议为此患者启用辅助输入模式。",
  "ui.provider.settings.accessibility.keep_screen_awake_label": "保持屏幕常亮",
  "ui.provider.settings.accessibility.keep_screen_awake_description": "在 OwnVoice 打开时防止 iPad 变暗或锁定。对于仅使用电池供电的工作站，请禁用此选项。",
  ...
  "ui.provider.settings.patients.active_discharge_hint":
    "请先切换到其他患者再为此患者办理出院。",
  "ui.provider.settings.patients.discharge_dialog.title": "为{name}办理出院？",
  "ui.provider.settings.patients.discharge_dialog.body":
    "这将删除其所有对话、音频缓存和活动日志条目。此操作无法撤销。",
  "ui.provider.settings.patients.discharge_dialog.confirm": "出院",
  ...
  "ui.provider.settings.activity_log.heading": "活动日志",
  ...
  "ui.provider.settings.offline.models_on_device": "语音与朗读模型：设备上已存 {bytes}",
  "ui.provider.settings.offline.models_not_yet_downloaded": "尚未下载模型",
  "ui.provider.settings.offline.storage_protected": "存储受保护 — 模型将保留在此设备上",
  "ui.provider.settings.offline.storage_not_protected": "存储未受保护 — 请将此应用添加到主屏幕，以便将模型保留在设备上",
  "ui.provider.settings.offline.storage_last_used": "上次使用：{relative}",
  "ui.provider.settings.offline.check_protection_button": "检查保护状态",
  "ui.provider.settings.offline.origin_usage_estimate": "源使用情况：约 {used} 已使用 / 约 {total} 可用（估算）",
  ...
  "ui.provider.patients.action_discharge": "出院",
