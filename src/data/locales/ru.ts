...
const ru: LocaleStrings = {
  ...
  "ui.provider.voice_capture.err_too_short":
    "Запись слишком короткая. Говорите в течение всего обратного отсчёта, затем нажмите «Повторить».",
  "ui.provider.voice_capture.err_too_noisy":
    "Фоновый шум слишком громкий для качественного клонирования голоса. Перейдите в более тихое место и нажмите «Повторить».",
