...
const sw: LocaleStrings = {
  ...
  "ui.provider.settings.accessibility.keep_screen_awake_label": "Endeleza skrini ikiwa hai",
  "ui.provider.settings.accessibility.keep_screen_awake_description": "Huzuia iPad isizimike au kufungwa wakati OwnVoice imefunguliwa. Zima kwa vituo vinavyotumia betri pekee.",
