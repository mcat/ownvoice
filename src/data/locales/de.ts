...
const de: LocaleStrings = {
  ...
  "needs.comfort.lights_on": "Bitte das Licht einschalten",
  "needs.comfort.lights_off": "Bitte das Licht ausschalten",
  "needs.comfort.lights_dimmed": "Bitte das Licht dimmen",
  ...
  "ui.patient.wishes.speak": "Sprechen",
  "ui.patient.wishes.back": "Zurück",
  ...
  "ui.dual.thread.scroll_up_aria": "Konversation nach oben scrollen",
  "ui.dual.thread.scroll_down_aria": "Konversation nach unten scrollen",
  ...
  "ui.provider.settings.accessibility.keep_screen_awake_label": "Bildschirm aktiv halten",
  "ui.provider.settings.accessibility.keep_screen_awake_description": "Verhindert, dass das iPad gedimmt oder gesperrt wird, solange OwnVoice geöffnet ist. Bei Stationen mit reinem Akkubetrieb deaktivieren.",
  ...
  "ui.provider.settings.offline.last_verified_prefix":
    "Zuletzt verifiziert: ",
  "ui.provider.settings.offline.models_on_device": "Sprach- und Sprechmodelle: {bytes} auf dem Gerät",
  "ui.provider.settings.offline.models_not_yet_downloaded": "Modelle noch nicht heruntergeladen",
  "ui.provider.settings.offline.storage_protected": "Speicher geschützt — Modelle bleiben auf diesem Gerät",
  "ui.provider.settings.offline.storage_not_protected": "Speicher nicht geschützt — fügen Sie diese App zum Home-Bildschirm hinzu, damit die Modelle auf dem Gerät bleiben",
  "ui.provider.settings.offline.storage_last_used": "Zuletzt verwendet: {relative}",
  "ui.provider.settings.offline.check_protection_button": "Schutzstatus prüfen",
  "ui.provider.settings.offline.origin_usage_estimate": "Ursprungsnutzung: ~{used} von ~{total} verfügbar verwendet (Schätzung)",
  ...
  "ui.provider.settings.voice_clone_status.extraction_failed": "Stimmklon nicht verfügbar – Ersatzstimme wird verwendet{fallback}",
  "ui.provider.settings.voice_clone_status.retry_extraction_aria": "Stimmklon-Extraktion erneut versuchen",
  "ui.provider.settings.voice_clone_status.quality_suffix": "Qualität: {label}",
};
