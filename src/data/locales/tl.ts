...
const tl: LocaleStrings = {
  ...
  "ui.provider.settings.accessibility.keep_screen_awake_label": "Panatilihing gising ang screen",
  "ui.provider.settings.accessibility.keep_screen_awake_description": "Pumipigil sa iPad na dumilim o ma-lock habang nakabukas ang OwnVoice. I-off para sa mga istasyong baterya lamang ang gamit.",
  ...
  "ui.provider.settings.voice_clone_status.extraction_failed": "Hindi available ang voice clone — ginagamit ang backup{fallback}",
  "ui.provider.settings.voice_clone_status.retry_extraction_aria": "Subukang muli ang voice clone extraction",
  "ui.provider.settings.voice_clone_status.quality_suffix": "kalidad: {label}",
};
