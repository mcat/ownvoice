...
const vi: LocaleStrings = {
  ...
  "ui.dual.thread.scroll_up_aria": "Cuộn cuộc trò chuyện lên",
  "ui.dual.thread.scroll_down_aria": "Cuộn cuộc trò chuyện xuống",
  ...
  "ui.provider.settings.accessibility.keep_screen_awake_label": "Giữ màn hình sáng",
  "ui.provider.settings.accessibility.keep_screen_awake_description": "Ngăn iPad bị mờ hoặc khóa khi OwnVoice đang mở. Tắt cho các trạm chỉ dùng pin.",
  ...
  "ui.provider.settings.patients.active_discharge_hint":
    "Chuyển sang bệnh nhân khác trước khi cho bệnh nhân này xuất viện.",
  "ui.provider.settings.patients.discharge_dialog.title": "Cho {name} xuất viện?",
  "ui.provider.settings.patients.discharge_dialog.body":
    "Thao tác này sẽ xóa tất cả cuộc trò chuyện, bộ đệm âm thanh và các mục nhật ký hoạt động. Không thể hoàn tác.",
  "ui.provider.settings.patients.discharge_dialog.confirm": "Xuất viện",
  ...
  "ui.provider.settings.activity_log.heading": "Nhật ký hoạt động",
  "ui.provider.settings.activity_log.description":
    "Sự kiện nói, xuất dữ liệu và hệ thống được ghi lại trên thiết bị này.",
  ...
  "ui.provider.patients.action_discharge": "Xuất viện",
  ...
  "ui.provider.settings.voice_clone_status.extraction_failed": "Bản sao giọng nói không khả dụng — đang sử dụng giọng dự phòng{fallback}",
  "ui.provider.settings.voice_clone_status.retry_extraction_aria": "Thử lại trích xuất bản sao giọng nói",
  "ui.provider.settings.voice_clone_status.quality_suffix": "chất lượng: {label}",
};
