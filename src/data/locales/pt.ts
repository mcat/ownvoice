...
const pt: LocaleStrings = {
  ...
  "needs.comfort.lights_on": "Acenda a luz",
  "needs.comfort.lights_off": "Apague a luz",
  "needs.comfort.lights_dimmed": "Diminua a luz",
  ...
  "needs.hygiene.mouth": "Façam minha higiene bucal",
  ...
  "ui.patient.wishes.speak": "Falar",
  "ui.patient.wishes.back": "Voltar",
  ...
  "ui.provider.listen.audio_level_aria": "Nível de áudio do microfone",
  ...
  "ui.provider.settings.accessibility.keep_screen_awake_label": "Manter ecrã ativo",
  "ui.provider.settings.accessibility.keep_screen_awake_description": "Impede que o iPad escureça ou bloqueie enquanto o OwnVoice está aberto. Desative em estações que funcionem apenas a bateria.",
  ...
  "ui.provider.settings.patients.active_discharge_hint":
    "Troque para outro paciente antes de dar alta a este.",
  "ui.provider.settings.patients.discharge_dialog.title": "Dar alta a {name}?",
  "ui.provider.settings.patients.discharge_dialog.body":
    "Isso exclui todas as conversas, o cache de áudio e as entradas do registro de atividades. Não pode ser desfeito.",
  "ui.provider.settings.patients.discharge_dialog.confirm": "Dar alta",
  ...
  "ui.provider.settings.activity_log.heading": "Registro de atividades",
  "ui.provider.settings.activity_log.description":
    "Eventos de fala, exportações e do sistema registrados neste dispositivo.",
  ...
  "ui.provider.patients.action_discharge": "Dar alta",
  ...
  "ui.voice_quality.title": "Qualidade de voz",
  "ui.voice_quality.label.good": "Boa",
  "ui.voice_quality.label.ok": "OK",
  "ui.voice_quality.label.poor": "Precisa melhorar",
  "ui.voice_quality.tip.snr": "Tente gravar num local mais silencioso.",
  "ui.voice_quality.tip.clipping": "Afaste-se um pouco do microfone.",
  "ui.voice_quality.tip.coverage": "Tente ler um pouco mais.",
  "ui.voice_quality.tip.voiced_fraction": "Tente continuar a falar durante toda a gravação.",
  "ui.voice_quality.tip.pitch_variation": "Leia de forma mais natural — deixe a sua voz subir e descer.",
  "ui.voice_quality.tip.loudness": "Procure manter o volume constante.",
  "ui.voice_quality.tip.tilt_boomy": "Afaste-se um pouco mais do microfone.",
  "ui.voice_quality.tip.tilt_tinny": "Este microfone soa fino — experimente outro, se tiver.",
  "ui.provider.settings.voice_clone_status.extraction_failed": "Clone de voz indisponível — usando voz de reserva{fallback}",
  "ui.provider.settings.voice_clone_status.retry_extraction_aria": "Tentar novamente a extração do clone de voz",
  "ui.provider.settings.voice_clone_status.quality_suffix": "qualidade: {label}",
};
