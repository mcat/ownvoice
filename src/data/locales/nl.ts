...
const nl: LocaleStrings = {
  ...
  "ui.provider.settings.accessibility.keep_screen_awake_label": "Scherm wakker houden",
  "ui.provider.settings.accessibility.keep_screen_awake_description": "Voorkomt dat de iPad dimt of vergrendelt terwijl OwnVoice open is. Schakel uit voor stations die alleen op accu draaien.",
  ...
  "ui.provider.settings.patients.active_discharge_hint":
    "Wissel eerst naar een andere patiënt voordat u deze ontslaat.",
  "ui.provider.settings.patients.discharge_dialog.title": "{name} ontslaan?",
  "ui.provider.settings.patients.discharge_dialog.body":
    "Dit verwijdert alle gesprekken, de audiocache en de vermeldingen in het activiteitenlogboek. Dit kan niet ongedaan worden gemaakt.",
  "ui.provider.settings.patients.discharge_dialog.confirm": "Ontslaan",
  ...
  "ui.provider.settings.activity_log.heading": "Activiteitenlogboek",
  "ui.provider.settings.activity_log.description":
    "Spraak-, export- en systeemgebeurtenissen die op dit apparaat zijn vastgelegd.",
  ...
  "ui.provider.settings.offline.last_verified_prefix":
    "Laatst geverifieerd: ",
  "ui.provider.settings.offline.models_on_device": "Stem- en spraakmodellen: {bytes} op apparaat",
  "ui.provider.settings.offline.models_not_yet_downloaded": "Modellen nog niet gedownload",
  "ui.provider.settings.offline.storage_protected": "Opslag beschermd — modellen blijven op dit apparaat",
  "ui.provider.settings.offline.storage_not_protected": "Opslag niet beschermd — voeg deze app toe aan het beginscherm om de modellen op het apparaat te houden",
  "ui.provider.settings.offline.storage_last_used": "Laatst gebruikt: {relative}",
  "ui.provider.settings.offline.check_protection_button": "Beschermingsstatus controleren",
  "ui.provider.settings.offline.origin_usage_estimate": "Origingebruik: ~{used} gebruikt van ~{total} beschikbaar (schatting)",
  ...
  "ui.provider.patients.action_discharge": "Ontslaan",
  ...
  "ui.provider.settings.voice_clone_status.extraction_failed": "Stemkloon niet beschikbaar — back-upstem wordt gebruikt{fallback}",
  "ui.provider.settings.voice_clone_status.retry_extraction_aria": "Stemkloon-extractie opnieuw proberen",
  "ui.provider.settings.voice_clone_status.quality_suffix": "kwaliteit: {label}",
};
