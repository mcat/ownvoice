...
const it: LocaleStrings = {
  ...
  "quick.retract": "Non intendevo questo",
  ...
  "needs.comfort.hearing_aid": "Ho bisogno del mio apparecchio acustico",
  "needs.comfort.glasses": "Ho bisogno dei miei occhiali",
  "needs.comfort.ice": "Ho bisogno di pezzetti di ghiaccio",
  "needs.comfort.pillow": "Sistemate il mio cuscino",
  "needs.comfort.turn": "Per favore giratemi",
  "needs.comfort.sit_up": "Aiutatemi a mettermi seduto",
  "needs.comfort.quiet": "Per favore fate silenzio",
  "needs.comfort.lights_on": "Accendi le luci",
  "needs.comfort.lights_off": "Spegni le luci",
  "needs.comfort.lights_dimmed": "Abbassa le luci",
  ...
  "needs.medical.call_light": "Ho bisogno di aiuto subito",
  "ui.patient.help.label": "Aiuto",
  ...
  "needs.people.respiratory_therapist": "Ho bisogno del fisioterapista respiratorio",
  "needs.people.speech_therapist": "Ho bisogno del logopedista",

  // ── Patient needs: Hygiene ─────────────────────────────────────
  "needs.hygiene.back": "Lavatemi la schiena",
  "needs.hygiene.face": "Lavatemi il viso",
  "needs.hygiene.feet": "Lavatemi i piedi",
  "needs.hygiene.hair": "Lavatemi i capelli",
  "needs.hygiene.hands": "Lavatemi le mani",
  "needs.hygiene.mouth": "Fatemi l'igiene orale",
  "needs.hygiene.nose": "Pulitemi il naso",
  "needs.hygiene.teeth": "Lavatemi i denti",
  "needs.hygiene.wound": "Cambiatemi la medicazione",
  ...
  "feelings.physical.wet": "Sono bagnato",
  "feelings.physical.gagging": "Ho conati di vomito",
  "feelings.physical.short_of_breath": "Mi manca il fiato",
  "feelings.physical.nauseated": "Ho la nausea",
  "feelings.physical.worse": "Mi sento peggio",
  ...
  "questions.extubation": "Quando mi tolgono il tubo?",
  ...
  "ui.patient.wishes.speak": "Parla",
  "ui.patient.wishes.back": "Indietro",
  ...
  "ui.dual.thread.scroll_up_aria": "Scorri conversazione verso l'alto",
  "ui.dual.thread.scroll_down_aria": "Scorri conversazione verso il basso",
  ...
  "ui.provider.voice_capture.err_too_short":
    "La registrazione era troppo breve. Parli per tutta la durata del conto alla rovescia, poi tocchi Riprova.",
  "ui.provider.voice_capture.err_too_noisy":
    "Il rumore di fondo era troppo alto per un clone vocale pulito. Si sposti in un luogo più silenzioso e tocchi Riprova.",
  ...
  "ui.provider.settings.accessibility.keep_screen_awake_label": "Mantieni lo schermo attivo",
  "ui.provider.settings.accessibility.keep_screen_awake_description": "Impedisce all'iPad di affievolirsi o bloccarsi mentre OwnVoice è aperto. Disattiva per stazioni alimentate solo a batteria.",
  ...
  "ui.provider.settings.patients.active_discharge_hint":
    "Passi a un altro paziente prima di dimettere questo.",
  "ui.provider.settings.patients.discharge_dialog.title": "Dimettere {name}?",
  "ui.provider.settings.patients.discharge_dialog.body":
    "Verranno eliminate tutte le conversazioni, la cache audio e le voci del registro attività. L'operazione non può essere annullata.",
  "ui.provider.settings.patients.discharge_dialog.confirm": "Dimetti",
  ...
  "ui.provider.settings.activity_log.heading": "Registro attività",
  "ui.provider.settings.activity_log.description":
    "Eventi di parlato, esportazioni e di sistema registrati su questo dispositivo.",
  ...
  "ui.provider.settings.offline.last_verified_prefix":
    "Ultima verifica: ",
  "ui.provider.settings.offline.models_on_device": "Modelli vocali e di parlato: {bytes} sul dispositivo",
  "ui.provider.settings.offline.models_not_yet_downloaded": "Modelli non ancora scaricati",
  "ui.provider.settings.offline.storage_protected": "Archiviazione protetta — i modelli rimarranno su questo dispositivo",
  "ui.provider.settings.offline.storage_not_protected": "Archiviazione non protetta — aggiungi questa app alla schermata Home per mantenere i modelli sul dispositivo",
  "ui.provider.settings.offline.storage_last_used": "Ultimo utilizzo: {relative}",
  "ui.provider.settings.offline.check_protection_button": "Verifica stato di protezione",
  "ui.provider.settings.offline.origin_usage_estimate": "Utilizzo origine: ~{used} usati su ~{total} disponibili (stima)",
  ...
  "ui.provider.patients.action_discharge": "Dimetti",
  ...
  "ui.voice_quality.title": "Qualità della voce",
  "ui.voice_quality.label.good": "Buona",
  "ui.voice_quality.label.ok": "OK",
  "ui.voice_quality.label.poor": "Da migliorare",
  "ui.voice_quality.tip.snr": "Prova a registrare in un posto più silenzioso.",
  "ui.voice_quality.tip.clipping": "Allontanati un po' dal microfono.",
  "ui.voice_quality.tip.coverage": "Prova a leggere ancora un po'.",
  "ui.voice_quality.tip.voiced_fraction": "Cerca di parlare per tutta la durata della registrazione.",
  "ui.voice_quality.tip.pitch_variation": "Leggi in modo più naturale — lascia che la voce salga e scenda.",
  "ui.voice_quality.tip.loudness": "Cerca di mantenere il volume costante.",
  "ui.voice_quality.tip.tilt_boomy": "Allontanati un po' di più dal microfono.",
  "ui.voice_quality.tip.tilt_tinny": "Questo microfono ha un suono sottile — prova un altro, se ne hai.",
  "ui.provider.settings.voice_clone_status.extraction_failed": "Clone vocale non disponibile — uso della voce di riserva{fallback}",
  "ui.provider.settings.voice_clone_status.retry_extraction_aria": "Riprova l'estrazione del clone vocale",
  "ui.provider.settings.voice_clone_status.quality_suffix": "qualità: {label}",
};
