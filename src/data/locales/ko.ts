...
const ko: LocaleStrings = {
  ...
  "ui.provider.staff_sheet.settings_description": "케어 팀, 접근성, 오프라인",
  "ui.provider.staff_sheet.end_session_description": "스태프 모드 종료",
  ...
  "ui.provider.settings.accessibility.keep_screen_awake_label": "화면 켜짐 유지",
  "ui.provider.settings.accessibility.keep_screen_awake_description": "OwnVoice가 열려 있는 동안 iPad가 어두워지거나 잠기지 않도록 합니다. 배터리만 사용하는 스테이션에서는 비활성화하세요.",
  ...
  "ui.provider.settings.voice_clone_status.extraction_failed": "음성 클론을 사용할 수 없음 — 백업 음성 사용 중{fallback}",
  "ui.provider.settings.voice_clone_status.retry_extraction_aria": "음성 클론 추출 다시 시도",
  "ui.provider.settings.voice_clone_status.quality_suffix": "품질: {label}",
};
