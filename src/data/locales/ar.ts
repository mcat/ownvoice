...
const ar: LocaleStrings = {
  ...
  "ui.dual.thread.scroll_up_aria": "تمرير المحادثة لأعلى",
  "ui.dual.thread.scroll_down_aria": "تمرير المحادثة لأسفل",
  ...
  "ui.provider.settings.accessibility.keep_screen_awake_label": "إبقاء الشاشة مضاءة",
  "ui.provider.settings.accessibility.keep_screen_awake_description": "يمنع iPad من الخفت أو القفل أثناء فتح OwnVoice. عطّله للمحطات التي تعمل بالبطارية فقط.",
  ...
  "ui.provider.settings.patients.active_discharge_hint":
    "بدّل إلى مريض آخر قبل إخراج هذا المريض.",
  "ui.provider.settings.patients.discharge_dialog.title": "إخراج {name}؟",
  "ui.provider.settings.patients.discharge_dialog.body":
    "سيُحذف بذلك جميع محادثاته وذاكرة الصوت المؤقتة وإدخالات سجل النشاط. لا يمكن التراجع عن ذلك.",
  "ui.provider.settings.patients.discharge_dialog.confirm": "إخراج",
  ...
  "ui.provider.settings.activity_log.heading": "سجل النشاط",
  "ui.provider.settings.activity_log.description":
    "أحداث النطق والتصدير وأحداث النظام المسجَّلة على هذا الجهاز.",
  ...
  "ui.provider.patients.action_discharge": "إخراج",
  ...
  "ui.provider.settings.voice_clone_status.extraction_failed": "استنساخ الصوت غير متاح — استخدام صوت احتياطي{fallback}",
  "ui.provider.settings.voice_clone_status.retry_extraction_aria": "إعادة محاولة استخراج استنساخ الصوت",
  "ui.provider.settings.voice_clone_status.quality_suffix": "الجودة: {label}",
};
